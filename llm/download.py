...
def set_config(dl_model):
    ...
    check_if_path_exists(os.path.join(model_spec_path, MODEL_STORE, dl_model.model_name+'.mar'), 'Model store') # Check if mar file exists
...
def run_script(args):
    ...
    dl_model.mar_output = os.path.join(dl_model.output, dl_model.model_name, dl_model.repo_version, MODEL_STORE)
